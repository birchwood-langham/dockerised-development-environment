# Generated by Powerlevel10k configuration wizard on 2020-04-04 at 09:53 CEST.
...
() {
  ...
  P10K_CONFIG=$HOME/.config/p10k

  if [[ -f $P10K_CONFIG/task.zsh ]]; then
    source $P10K_CONFIG/task.zsh
  fi

  if [[ -f $P10K_CONFIG/java_version.zsh ]]; then
      source $P10K_CONFIG/java_version.zsh
  fi
